...
//
//  This is an example database entity using Unrealm
//
...
extension ToDoItem
{
    ...
    {
        return realm.objects(ToDoItem.self).sorted(byKeyPath: "isCompleted")
    }
    
    @discardableResult  //  Discardable result removes the "variable is not used" warning since the result might not be used by the caller
